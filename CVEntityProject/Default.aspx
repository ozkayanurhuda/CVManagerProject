...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            <img src="web/images/pp.jpeg" alt="news image" class="img-fluid navimg">
            <h1 class="top_hd mt-2"><a href="web/index.html">Nurhüda Özkaya</a></h1>
            ...
            <div class="nav-top">
                <nav class="mnu mx-auto">
                    ...
                    <ul class="menu">
                        ...
                        <li class="mt-sm-3"><a href="#services" class="scroll">Abilities</a></li>
                        <li class="mt-sm-3"><a href="#news" class="scroll">Work Experience</a></li>
    ...
    <div class="main">
        ...
        <div class="news" id="news">
            <h3 class="w3_head mb-4 text-left">Work Experience</h3>
        ...
        <section class="wedo" id="contact">
            ...
            <div class="cpy-right text-center">
                <p>
                   Likedln Account
					<a href="https://www.linkedin.com/in/nur-%C3%B6zkaya/">Nurhüda Özkaya</a>
                </p>
            </div>
        </section>
        <!-- //contact -->
